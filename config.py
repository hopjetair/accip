...
const_cloudhost = "database-1.c50k40mcme1j.ap-southeast-2.rds.amazonaws.com"
...
if nonprod:
    ...
    db_host = os.getenv("db_host", const_cloudhost)  # "localhost")
    
db_name = os.getenv("db_name", "hopjetairline_db")
db_user = os.getenv("db_user", const_db_user)
db_pass = os.getenv("db_pass", const_db_pass)
